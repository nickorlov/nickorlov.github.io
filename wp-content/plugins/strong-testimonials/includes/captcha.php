	...
	switch ( $captcha ) {
		...
		case 'miyoshi' :
			if ( class_exists( 'ReallySimpleCaptcha' ) ) {
				...
				$html .= '<span>' . _x( 'Введите код с картинки ', 'Captcha', 'strong-testimonials' ) . '&nbsp;<input type="hidden" name="captchac" value="'.$prefix.'"><img class="captcha" src="' . plugins_url( 'really-simple-captcha/tmp/' ) . $image . '"></span>';
